...
line_bot_api= LineBotApi('dQc4WTdAMkKkT3fhGyIko0eTJS20r71jbYB5HCDfrYU/ls0islOwi5rW+/n/APqFGKGAXf6utrRj37m/eHs06t4gbPAfAH5Qt0VOioQ2mbOx799We+l3ZD9hQYAzcSiHecJscOP6ywBVp3bpHBYm3AdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('935e1ee20389a50375e13365eb4461a2')
line_bot_api.push_message("Uc25977ef793ab70b745d64f1078b1655", TextSendMessage(text='嗨囉~~我是和泉沙霧owo'))
...
if __name__ == "__main__":
    app.run(host="0.0.0.0",port=9325)
